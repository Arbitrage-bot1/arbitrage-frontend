...
const PriceMonitor = () => {
    ...
    const gethistorydata = async () => {
        ...
        try {
            const res = await axios.post("https://arbitrage-backend-s5jo.onrender.com/api/history/gethistory", data);
            setLog(res.data);
        } catch (error) {
    ...
    const getdata = async () => {
        ...
        try {
            ...
            await axios.post("https://arbitrage-backend-s5jo.onrender.com/api/saveData", data);
    ...
    //         try {
    //             await axios.post('https://arbitrage-backend-s5jo.onrender.com/api/logs', logEntry);
    ...
    const handleDownload = async () => {
        ...
        try {
            const response = await axios.post("https://arbitrage-backend-s5jo.onrender.com/api/download-excel", data,{
                responseType: "blob"
            });
